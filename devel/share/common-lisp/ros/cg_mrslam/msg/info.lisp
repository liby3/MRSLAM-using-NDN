...
(cl:defmethod cl:initialize-instance :after ((m <info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cg_mrslam-msg:<info> is deprecated: use cg_mrslam-msg:info instead.")))

(cl:ensure-generic-function 'testInfo-val :lambda-list '(m))
(cl:defmethod testInfo-val ((m <info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cg_mrslam-msg:testInfo-val is deprecated.  Use cg_mrslam-msg:testInfo instead.")
  (testInfo m))
